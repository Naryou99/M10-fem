...
import 'package:m10/pertemuan10/components/fullscreen_dialog_widget.dart';
        ...
        MaterialBanner(
          content: Column(
            ...
            children: const [
              ...
              Text('Dialog inform users about a task and can contain critical \n information, require decisions, or invoive multiple tasks')
            ]),
          actions: [
            TextButton(
        ...
        MaterialBanner(
          content: Column(
            ...
            children: const[
              ...
              Text('Snackbar provide brief messages about \n app processes at the bottom of the screen'),
               SizedBox(
          height: 20,
          ),
            ]
...
showBanner(BuildContext context) {
  return MaterialBanner(
    content: const Text('Pelan Pelan Pak Sopir'),
    leading: const Icon(
      Icons.info,
      color: Colors.orange,
    ),
...
showAlertDialog(BuildContext context) {
  return AlertDialog(
    ...
    content: const Text('This will reset your device to its default \n factory setting?',
